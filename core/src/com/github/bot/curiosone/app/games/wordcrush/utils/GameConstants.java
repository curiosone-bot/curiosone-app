...
public class GameConstants
{
    ...
    public static final String TEXTURE_ATLAS_OBJECTS = "wordcrushassets/totalAssets.txt";

    /* Location of vocabulary */
    public static final String VOCABULARY = "wordcrushassets/txt/vocabulary3000.txt";

    /* Font score*/
    public static final String FONT_SCORE = "wordcrushassets/fontScuro.fnt";
