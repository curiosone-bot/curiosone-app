package com.github.bot.curiosone.app.com.curiosone.wordtiles.Spawner;
...
import com.curiosone.wordtiles.Sprites.AbstractTile;
import com.curiosone.wordtiles.Sprites.Tile;
import com.curiosone.wordtiles.Sprites.WrongTile;
...
public class TileSpawner implements Iterable<AbstractTile>{
    ...
    public static final BitmapFont font = new BitmapFont(Gdx.files.internal("Font/lexie.fnt"));
    ...
    public TileSpawner() {
        ...
        switch (Settings.MODE){
            case EASY:
                words = new Array<String>(generateWords("Texts/Animals_Easy"));
                wrongWords = new Array<String>(generateWords("Texts/BodyParts_Easy"));
                break;
            case NORMAL:
                words = new Array<String>(generateWords("Texts/Animals_Normal"));
                wrongWords = new Array<String>(generateWords("Texts/BodyParts_Normal"));
                break;
            case HARD:
                words = new Array<String>(generateWords("Texts/Animals_Hard"));
                wrongWords = new Array<String>(generateWords("Texts/BodyParts_Hard"));
                break;
            case EXTREME:
                words = new Array<String>(generateWords("Texts/Animals_Extreme"));
                wrongWords = new Array<String>(generateWords("Texts/BodyParts_Extreme"));
                break;
        }
        spawner();
    }
