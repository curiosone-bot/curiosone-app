...
import com.curiosone.wordtiles.Spawner.TileSpawner;
...
public class PlayScreen extends ScreenAdapter {
    ...
    public PlayScreen(WordTiles game) {
        //Spawning the tiles
        ...
        //Miscellaneous
        this.gameOverSound = Gdx.audio.newSound(Gdx.files.internal("Sound Effects/GameOver.wav"));
        this.gameOverTexture = new Texture("GameOver.png");
        this.backButton = new Rectangle(325,180,84,84);
        this.winTexure = new Texture("Win.png");
