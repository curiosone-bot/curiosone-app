...
public class Assets implements Disposable,AssetErrorListener
{
    ...
    public void init(AssetManager assetManager)
    {
        ...
        assetManager.load("gameModeTexture.txt", TextureAtlas.class);
        assetManager.load("difficultyGameAssets.txt", TextureAtlas.class);
        assetManager.load("rememberAssets.txt", TextureAtlas.class);
        assetManager.load("tileDownAssets.txt", TextureAtlas.class);
        assetManager.load("endAssets.txt", TextureAtlas.class);
        assetManager.load("remberFont.fnt", BitmapFont.class);
        assetManager.load("darkBlueFont.fnt", BitmapFont.class);
        assetManager.load("yellowFont.fnt", BitmapFont.class);

        /* Audio load */
        assetManager.load("audio/Greasy.mp3", Music.class);
        assetManager.load("audio/CoralReef.mp3", Music.class);
        assetManager.load("audio/GameSong.mp3", Music.class);
        assetManager.load("audio/TumCrash.mp3", Sound.class);
        assetManager.load("audio/ClickMenuButton.mp3", Sound.class);
        assetManager.load("audio/LetterSound.mp3", Sound.class);
        assetManager.load("audio/Ding.mp3", Sound.class);
        assetManager.load("audio/ErrorSound.mp3", Sound.class);
        assetManager.load("audio/Boing.mp3", Sound.class);
        ...
        TextureAtlas atlas1 = assetManager.get("gameModeTexture.txt");
        TextureAtlas atlas2 = assetManager.get("difficultyGameAssets.txt");
        TextureAtlas atlas3 = assetManager.get("rememberAssets.txt");
        TextureAtlas atlas4 = assetManager.get("tileDownAssets.txt");
        TextureAtlas atlas5 = assetManager.get("endAssets.txt");
    ...
    public class AssetSound
    {
        ...
        {
            tumCrash = assetManager.get("audio/TumCrash.mp3", Sound.class);
            clickMenuButton = assetManager.get("audio/ClickMenuButton.mp3", Sound.class);
            letterSound = assetManager.get("audio/LetterSound.mp3", Sound.class);
            ding = assetManager.get("audio/Ding.mp3", Sound.class);
            errorSound = assetManager.get("audio/ErrorSound.mp3", Sound.class);
            boing = assetManager.get("audio/Boing.mp3", Sound.class);
        }
    ...
    public class AssetMusic
    {
        ...
        {
            slidy = assetManager.get("audio/Greasy.mp3", Music.class);
            hawaii = assetManager.get("audio/CoralReef.mp3", Music.class);
            rocker = assetManager.get("audio/GameSong.mp3", Music.class);
        }
    }
    /**
    ...
    public BitmapFont getBitmapFontRemember() { return assetManager.get("remberFont.fnt"); }
    public BitmapFont getDarkBlueFont () { return assetManager.get("darkBlueFont.fnt"); }
    public BitmapFont getYellowFont () { return  assetManager.get("yellowFont.fnt"); }
